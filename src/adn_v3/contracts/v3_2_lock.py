...
COMPONENT_ID = 'adn'
COMPONENT_NAME = 'DigiByte Active Defense Network'
SUPPORTED_REASON_IDS = ('ADN_OK_COORDINATION_ALLOW', 'ADN_ESCALATE_POLICY_REVIEW', 'ADN_DENY_DEFENSE_TRIGGERED', 'ADN_ERROR_INVALID_VERDICT', 'ADN_ERROR_CONTEXT_HASH_MISMATCH')
SUPPORTED_EVIDENCE_FAMILIES = ('defense_signal', 'policy_context', 'coordination_state')
